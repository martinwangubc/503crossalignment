...
class Model(object):
    ...
    def __init__(self, args, vocab):
        ...
        #     'embedding', 'projection'])
        # theta_d05 = retrive_var(['discriminator04'])
        # theta_d15 = retrive_var(['discriminator14'])
        #
...
if __name__ == '__main__':
    ...
    if args.train:
        ...
        if not os.path.isfile(args.vocab2):
            build_vocab(train0 + train2, args.vocab2)
#        if not os.path.isfile(args.vocab3):
#            build_vocab(train0 + train3, args.vocab3)
#        if not os.path.isfile(args.vocab4):
#            build_vocab(train0 + train4, args.vocab4)
#        if not os.path.isfile(args.vocab5):
#            build_vocab(train0 + train5, args.vocab5)

    vocab = Vocabulary(args.vocab, args.embedding, args.dim_emb)
    vocab2 = Vocabulary(args.vocab2, args.embedding, args.dim_emb)
    # vocab3 = Vocabulary(args.vocab3, args.embedding, args.dim_emb)
    # vocab4 = Vocabulary(args.vocab4, args.embedding, args.dim_emb)
    # vocab5 = Vocabulary(args.vocab5, args.embedding, args.dim_emb)

    print 'vocabulary 1 size:', vocab.size
    print 'vocabulary 2 size:', vocab2.size
#    print 'vocabulary 3 size:', vocab3.size
#    print 'vocabulary 4 size:', vocab4.size
#    print 'vocabulary 5 size:', vocab5.size
    ...
    with tf.Session(config=config) as sess:
        ...
        if args.train:
            ...
            batches2, _, _ = get_batches(train0, train2, vocab2.word2id,
                args.batch_size, noisy=True)
            random.shuffle(batches2)

#            batches3, _, _ = get_batches(train0, train3, vocab3.word2id,
#                args.batch_size, noisy=True)
#            random.shuffle(batches3)

#            batches4, _, _ = get_batches(train0, train4, vocab4.word2id,
#                args.batch_size, noisy=True)
#            random.shuffle(batches4)

#            batches5, _, _ = get_batches(train0, train5, vocab5.word2id,
#                args.batch_size, noisy=True)
            ...
            for epoch in range(1, 1+args.max_epochs):
                ...
                # print(linearoutput)
                    ...
                    if step % args.steps_per_checkpoint == 0:
                        ...
                        losses.clear()
                if args.dev:
                    dev_losses = transfer(model, decoder, sess, args, vocab2,
...
# part 3
    ...
    #                     losses.clear()
    #             if args.dev:
    #                 dev_losses = transfer(model, decoder, sess, args, vocab3,
    ...
    #                     losses.clear()
    #             if args.dev:
    #                 dev_losses = transfer(model, decoder, sess, args, vocab4,
    ...
    #                     losses.clear()
    #             if args.dev:
    #                 dev_losses = transfer(model, decoder, sess, args, vocab5,
    ...
    # going through twice
        ...
        if args.test:
            ...
            test_losses2 = transfer(model, decoder, sess, args, vocab2,
