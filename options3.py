...
def load_arguments():
    ...
    argparser.add_argument('--output',
            type=str,
            default='')
    argparser.add_argument('--output2',
            type=str,
            default='')
#    argparser.add_argument('--output3',
#            type=str,
#            default='')
#    argparser.add_argument('--output4',
#            type=str,
#            default='')
#    argparser.add_argument('--output5',
#            type=str,
#            default='')
    argparser.add_argument('--vocab',
            type=str,
            default='')
    argparser.add_argument('--vocab2',
            type=str,
            default='')
#    argparser.add_argument('--vocab3',
#            type=str,
#            default='')
#    argparser.add_argument('--vocab4',
#            type=str,
#            default='')
#    argparser.add_argument('--vocab5',
#            type=str,
#            default='')
